		        ...
		        <div class="container">
		        	<div class="row">
		        		<div class="col-md-3 footer-about wow fadeInUp">
		        			<h3>About us</h3>
		        			<p>
		        				CRF is a transport  service company specializes in Sedan & Taxi airport transfers, shuttle service and affordable taxi service for Gauteng area.
		        			</p>
		        			<p>&copy; <?php print date("Y");?> Copyright- All Rights Reserved</p>
	                    </div>
